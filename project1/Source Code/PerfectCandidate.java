...
/**
* The main function of this program is to read information from a file to
* create a ballot with candidates on it which the user will be able to vote for
* and then view the results from the ballot in a nicely formatted file.
*/
